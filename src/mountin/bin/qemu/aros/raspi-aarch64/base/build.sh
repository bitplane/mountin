...
GUEST_DIR=/host/build/guest/aarch64-aros/2026-09-24
OUTPUT_DIR=/host/build/bin/qemu/aarch64-aros/2026-09-24
...
mcopy -i "$DISK@@$PARTITION_OFFSET" "$GUEST_DIR/iffparse.library" ::Libs/iffparse.library
