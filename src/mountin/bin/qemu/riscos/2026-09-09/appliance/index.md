...
`SDFS::0.$`. Whole-device new-map and old-map new-directory FileCore
filesystems pass the guest read checks. Other RISC OS filing-system drivers are documented in the guest
component definition; their device paths have not passed appliance tests. The
old-map old-directory FileCore fixture currently returns an I/O error through
SDFS.
...
and child enumeration and file contents.
