...
tar -xf /host/build/sources/9d-0.7.15.tar.xz \
...
make -C "$source" release \
    ...
    RELEASE_CFLAGS='-O2 -DNDEBUG -fno-common -ffunction-sections -fdata-sections -DS9_PATH_MAX=1024' \
...
elf2aif "$source/build/9d" "$output"
